...
edge-impulse-uploader --label housefinch --category training data/splits/**/training/housefinch/*.wav
...
edge-impulse-uploader --label housefinch --category testing data/splits/**/testing/housefinch/*.wav